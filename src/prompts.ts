  ...
  return [
    {
      role: "system",
      content:
        "你是一个新闻配图编导,擅长通读一篇文章后,把文章里真实出现的人物、场景、物件," +
        "转化为写实纪实摄影风格的英文画面描述,让配图和文章内容强相关。",
    },
    {
      role: "user",
      content:
        ...
        "硬性要求:\n" +
        `- 每条都必须对应文章里【具体出现过】的画面:主角的处境、关键场景、提到的地点/物件/行业现场等,不要泛泛而谈。\n` +
        "- 第 1 条是封面图,要抓住全文最具冲击力、最能代表主题的核心画面;其余每条各对应文中不同的段落或场景,彼此不重复。\n" +
        "- 风格:写实纪实/新闻摄影、photorealistic、构图干净、专业。\n" +
        "- 为避免画面出现乱码文字,避开任何天然带文字的元素(招牌/广告牌/报纸/书页/电脑或手机屏幕/海报/横幅/品牌 logo/车牌/字幕等)," +
        "改用人物表情、动作、环境、光线、物体等无文字画面;【不要】在描述里写 “no text”“without words” 这类否定词。\n" +
